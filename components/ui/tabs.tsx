...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      "disable:pointer-events-none inline-flex w-full items-center justify-center whitespace-nowrap rounded-lg bg-[#27272c] p-3 text-base font-medium text-white ring-offset-white transition-all disabled:opacity-50 data-[state=active]:bg-accent data-[state=active]:font-bold data-[state=active]:text-primary data-[state=active]:shadow-sm",
      className,
    )}
    {...props}
  />
